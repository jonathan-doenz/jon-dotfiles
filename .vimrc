...
" 			\ 'syntax': 'markdown', 'ext': '.md'}]
" Remove navigating tables with <Tab>
...
" Customize Visual mode highlight to avoid reverse video
highlight Visual cterm=none ctermbg=242 ctermfg=white guibg=#5c5c5c guifg=white
...
" The following are all snippets available in ~/jon-dotfiles/vim-snippets/snippets/tex.snippets
...
inoremap <silent><expr> <TAB>
      ...
      \ CheckBackspace() ? "\<Tab>" :
      \ coc#refresh()
" " Modified version suggested by ChatGPT-4o
" inoremap <silent><expr> <Tab>
"   \ coc#pum#visible() ? coc#pum#next(1) :
"   \ CheckBackspace() ? "\<Tab>" :
"   \ coc#refresh()
