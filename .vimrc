...
" runtime plugin/_autodoc.vim " this file is not present

"=====[ Enable Nmap command for documented mappings ]================
runtime ~/Dropbox/vim/plugin/yankmatches.vim

" =====[ Smart completion via <TAB> and <S-TAB> ]=============
runtime ~/Dropbox/vim/plugin/smartcom.vim

" =====[ Keep visual selection selected after a move ]=======
runtime ~/Dropbox/vim/plugin/persistentvisuals.vim
...
"==============[ Abbreviations ]================
" TeX abbreviations
	autocmd FileType tex nmap ;; <plug>(vimtex-compile)<plug>(vimtex-view)
